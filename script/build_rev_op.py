...
def build_hp_rev(org):
	di=os.getcwd()
	file1=org
	org=ngi=0

	dir1=di+"/../prep_hairpin/"+file1+'/reverse'
	org=org+1
	#-------------$organism contain organism name for genomes folder and gene id-----------------------------------#

	#---------------Writing output file------------------------------------------------------------
	filen=di+"/../complete_hpin/reverse_"+file1
	w=open(filen,"w")
	w.write( "============================================================================================================================================\n")
	w.write("\n\tOrganism: "+file1+"\n")
	w.write("============================================================================================================================================\n")
	...
	dir_seq=di+"/../genomes/"+file1+"/fasta_op/reverse/"
